...
## Generated on : Tue Jul 09 16:32:35 2024
...
SLIB_PATH                 = C:/Users/DELL/DOCUME~1/MATLAB/R2023a/ARDUIN~1/ESP32W~1/FASTER~1
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
OBJS = MW_analogWriteDAC.o MW_arduino_digitalio.o xcp_ext_mode.o rtGetInf.o rtGetNaN.o rt_nonfinite.o untitled.o untitled_data.o xcp_ext_common.o xcp_ext_classic_trigger.o xcp.o xcp_standard.o xcp_daq.o xcp_calibration.o xcp_fifo.o xcp_transport.o xcp_mem_default.o xcp_drv_rtiostream.o xcp_utils.o xcp_frame_serial.o xcp_ext_param_default_serial.o MW_ArduinoHWInit.o io_wrappers.o IPAddress.o Print.o mw_freertos_init.o mw_thread.o mw_timer.o mw_semaphore.o rtiostream_serial_daemon.o
...
MW_analogWriteDAC.o : C:/ProgramData/MATLAB/SupportPackages/R2023a/toolbox/target/supportpackages/arduinobase/src/MW_analogWriteDAC.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
mw_freertos_init.o : C:/ProgramData/MATLAB/SupportPackages/R2023a/toolbox/target/shared/freertos/src/mw_freertos_init.c
	$(CC) $(CFLAGS) -o "$@" "$<"


mw_thread.o : C:/ProgramData/MATLAB/SupportPackages/R2023a/toolbox/target/shared/freertos/src/mw_thread.c
	$(CC) $(CFLAGS) -o "$@" "$<"


mw_timer.o : C:/ProgramData/MATLAB/SupportPackages/R2023a/toolbox/target/shared/freertos/src/mw_timer.c
	$(CC) $(CFLAGS) -o "$@" "$<"


mw_semaphore.o : C:/ProgramData/MATLAB/SupportPackages/R2023a/toolbox/target/shared/freertos/src/mw_semaphore.c
	$(CC) $(CFLAGS) -o "$@" "$<"
